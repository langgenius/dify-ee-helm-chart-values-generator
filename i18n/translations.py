...
TRANSLATIONS = {
    'en': {
        ...
        'local_file_location': 'Please place values.yaml in the project root directory',
        'local_file_location_detail': 'Expected location: {path}',
        ...
        'downloading_chart': 'Downloading Helm Chart...',
        'chart_already_extracted': 'Chart already extracted',
        'chart_directory': 'Chart directory',
        'chart_directory_exists': 'Chart directory already exists',
        'chart_directory_exists_prompt': 'Directory already exists. What would you like to do?',
        'use_existing_directory': 'Use existing directory',
        'overwrite_existing_directory': 'Overwrite existing directory',
        'using_existing_directory': 'Using existing directory',
        'removing_existing_directory': 'Removing existing directory...',
        'chart_extracted_to': 'Chart extracted to',
        'chart_download_failed': 'Failed to download chart',
        'chart_extract_error': 'Chart extraction error',
        ...
        'preparing_version': 'Preparing configuration for Helm Chart version',
        ...
        'license_server_manual_config_note': 'Note: Please configure licenseServer URL manually in values.yaml if needed',
        ...
        'service_replica_config': 'Service Replica Configuration',
        'service_replica_config_note': 'Configuring replica counts for services (using default values from template)',
        'config_service_replicas': 'Configure service replica counts?',
        'replica_count_for': 'Replica count for {service}',
        'replica': 'replica',
        'invalid_replica_count': 'Invalid replica count',
        'using_default': 'using default',
        'service_disabled_skip_replica': 'Service disabled, skipping replica configuration',
    ...
    'zh': {
        ...
        'local_file_location': '请将 values.yaml 文件放在项目根目录',
        'local_file_location_detail': '期望位置: {path}',
        ...
        'downloading_chart': '正在下载 Helm Chart...',
        'chart_already_extracted': 'Chart 已提取',
        'chart_directory': 'Chart 目录',
        'chart_directory_exists': 'Chart 目录已存在',
        'chart_directory_exists_prompt': '目录已存在，您希望如何操作？',
        'use_existing_directory': '使用现有目录',
        'overwrite_existing_directory': '覆盖现有目录',
        'using_existing_directory': '使用现有目录',
        'removing_existing_directory': '正在删除现有目录...',
        'chart_extracted_to': 'Chart 已提取到',
        'chart_download_failed': '下载 Chart 失败',
        'chart_extract_error': 'Chart 提取错误',
        ...
        'preparing_version': '正在准备 Helm Chart 版本',
        'target_version': '目标版本',
        ...
        'license_server_manual_config_note': '注意：如需配置 licenseServer URL，请在 values.yaml 中手动设置',
        'service_enablement_status': '服务启用状态',
        'can_skip_use_defaults': '可以跳过此部分使用默认值，或根据需要调整',
        'config_service_enablement': '是否配置服务启用状态?',
        'enable_service': '是否启用',
        'service_replica_config': '服务副本数量配置',
        'service_replica_config_note': '配置各服务的副本数量（使用模板中的默认值）',
        'config_service_replicas': '是否配置服务副本数量？',
        'replica_count_for': '副本数量（{service}）',
        'replica': '副本',
        'invalid_replica_count': '无效的副本数量',
        'using_default': '使用默认值',
        'service_disabled_skip_replica': '服务已禁用，跳过副本配置',
